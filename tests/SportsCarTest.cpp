...
namespace adas
{
    ...
    // 测试输入：BL
    TEST_F(SportsCarTest, should_returny_y_plus_1_and_facing_S_given_command_is_BL_and_facing_is_E)
    {
        // when
        executor->Execute("BL");
        // then
    ...
    // 测试输入：FL
    TEST_F(SportsCarTest, should_return_x_plus_1_and_y_plus_1_and_facing_N_given_command_is_FL_and_facing_is_E)
    {
        // when
        executor->Execute("FL");
        // then
    ...
    // 测试输入：FBL
    TEST_F(SportsCarTest, should_return_x_minus_1_and_y_minus_1_facing_S_given_command_is_FBL_and_facing_is_E)
    {
        // when
